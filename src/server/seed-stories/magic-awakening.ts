...
export const magicAwakening: SeedStory = {
  ...
  entities: [
    ...
    },
    {
      ...
      metadata: {
        ...
        opinions: {
          Player:
            "They don't remember who they are, but that crystal isn't ordinary and neither are they. When they look at me, the shard burns — and so does my skin. I should be careful. But I brought them here. I tied the ribbon. Whatever this is, I started it.",
          "Madam Cressida":
    ...
    },
    {
      ...
      metadata: {
        ...
        opinions: {
          Player:
            "Came in on Veyla's arm, three nights ago. Unconscious. No name, no coin, but that crystal in their hand would fetch a month's earnings from the right buyer. Veyla is besotted — or ensorcelled. Either way, trouble is brewing, and I need to decide whose side I'm on before it boils over.",
          Veyla:
  ...
  relationships: [
    // ── Character Locations (LOCATED_AT) ───────────────────────────
    {
      sourceName: "Player",
      targetName: "The Velvet Thorn",
      type: "LOCATED_AT",
      description: "The player wakes in a velvet-draped room at the Velvet Thorn brothel.",
    },
    {
      sourceName: "Veyla",
      targetName: "The Velvet Thorn",
      type: "LOCATED_AT",
      description: "Veyla works and lives at the Velvet Thorn as a courtesan.",
    },
    {
      sourceName: "Madam Cressida",
      targetName: "The Velvet Thorn",
      type: "LOCATED_AT",
      description: "Cressida is the proprietor of the Velvet Thorn and rarely leaves it.",
    },

    // ── Object Possession (CARRIES) ────────────────────────────────
    {
      sourceName: "Player",
    ...
    // ── Character Relations (ALLIED_WITH) ──────────────────────────
    {
      ...
      type: "ALLIED_WITH",
      description:
        "Veyla is drawn to the player — protective, intrigued, and increasingly entangled. Something in the crystal sang to her blood.",
    },
    {
      sourceName: "Veyla",
      targetName: "Madam Cressida",
      type: "ALLIED_WITH",
      description:
        "Veyla has been with Cressida for two years. There is trust and wariness in equal measure.",
    },
    {
      sourceName: "Madam Cressida",
      targetName: "Veyla",
      type: "ALLIED_WITH",
      description:
        "Cressida protects Veyla — out of care, pragmatism, or both. She has not thrown the player out, partly for Veyla's sake.",
    },
    {
      sourceName: "Madam Cressida",
      targetName: "Player",
      type: "ALLIED_WITH",
      description:
        "Cressida is watching the player with guarded patience — they might be worth something to someone.",
    },

    // ── Location Hierarchy ─────────────────────────────────────────
    {
      sourceName: "The Velvet Thorn",
      targetName: "The Warrens",
      type: "LOCATED_IN",
      description: "The Velvet Thorn is nestled deep in the Warrens off the Sinking Dock.",
    },

    // ── Plot Structure (CHILD_PLOT) ────────────────────────────────
    {
    ...
    {
      sourceName: "The Awakening",
      targetName: "The Underworld",
      type: "CHILD_PLOT",
      description: "Navigate the lawless Warrens to find answers about the player's past.",
    },
    {
      sourceName: "The Awakening",
  ...
  initialDay: 1,
  initialSegment: 1,
  initialLocationId: "the_velvet_thorn",
};
