...
const JsonExplorer: React.FC<{ data: string | null; isWrapping?: boolean; className?: string }> = ({
  data,
  isWrapping = true,
          ...
          {allEntities.map((entity) => (
            ...
            >
              <div className="font-bold flex items-center justify-between">
                ...
                <span className="text-[8px] opacity-40 px-1 border border-current rounded-sm uppercase flex-shrink-0">
                  {entity.type}
                </span>
              </div>
          ...
          <div className="flex flex-col h-full">
            <div className="flex items-center justify-between h-9 mb-6">
              ...
              >
                <Save size={14} />
                <span className="text-[10px] font-bold uppercase tracking-wider">
                  {isSaving ? "Syncing..." : "Update_Manifest"}
                </span>
              </button>
            </div>
