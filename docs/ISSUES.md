...
Latest issue appears first.

## SSE Parser: Incorrect Message Typing and Annotation Leakage
**Date:** 2026-04-30
**Description:**
...
## Architecture Migration: Dual-LLM → Single-LLM Event-Driven
**Date:** 2026-04-30
**Description:**
...
## LLM Trace Formatting in Debug Panel (`DebugPanel.tsx`)
**Date:** 2026-04-29
**Description:** 
