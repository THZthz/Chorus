...
const objects: SeedStory["objects"] = {
  obsidian_lens: {
    ...
    shortDescription: "A lens of volcanic glass that shows stars that shouldn't exist — cold to the touch, even near flame.",
    longDescription:
    ...
    attributes: {
      ...
      "Effect on Observers": "Dreams → nightmares → waking visions → irreversible psychological damage",
  ...
  tome_fragment: {
    ...
    shortDescription: "A single page torn from a book that was burned three centuries ago — the ink still wet.",
    longDescription:
    ...
    attributes: {
      ...
      "Original Text": "Pre-alphabetic script — characters appear to move when not observed directly",
  ...
  star_chart: {
    ...
    shortDescription: "A celestial map that keeps changing — the constellations rearranging themselves toward a pattern that isn't finished yet.",
    longDescription:
...
const locations: SeedStory["locations"] = {
  celestial_athenaeum: {
    ...
    shortDescription: "A mountain-top observatory-library where forbidden knowledge is kept — and something beneath it is waking.",
    longDescription:
    ...
    attributes: {
      ...
      "Current State": "Silent for decades, now stirring — whispers, moving charts, impossible events",
...
const characters: SeedStory["characters"] = {
  astronomer_lyra: {
    ...
    shortDescription: "The Athenaeum's sole custodian — brilliant, isolated, and no longer certain what is real.",
    longDescription:
  ...
  archivist_elowen: {
    ...
    shortDescription: "A reclusive keeper of forbidden texts — ink-stained fingers, a tremor in her voice, and knowledge she wishes she could un-learn.",
    longDescription:
    ...
    attributes: {
      ...
      "Has Produced": "Journals filled with everything she's learned about the sleeper and the convergence",
  ...
  the_hermit: {
    ...
    shortDescription: "A figure in the vaults who hasn't seen the sun in twenty years — and no longer believes the sky is empty.",
    longDescription:
...
export const celestialAthenaeum: SeedStory = {
  ...
  rootPlot: {
    ...
    childPlots: [
      { plotId: null, triggerCondition: "Player works with Astronomer Lyra to understand the star chart's message, using science and sorcery to decode the convergence" },
      { plotId: null, triggerCondition: "Player delves into the vaults with Archivist Elowen, piecing together forbidden knowledge from her journals and the texts that curse those who read them" },
      { plotId: null, triggerCondition: "Player follows the Hermit's guidance into the deepest catacombs, learning the sleeper's true nature and the price of becoming its vessel" },
    ],
  },
